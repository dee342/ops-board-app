...
/**
 * Command to assign a piece of Equipment to a partial task / multi route.
 */
@IBoardCommandAnnotation(commandName = "AssignEquipmentToPartialTask")
public class CommandAssignEquipmentToPartialTask extends AbstractTaskEquipmentCommand {

	private static final long serialVersionUID = 1L;

	private List<TaskAssignment> assignments = new ArrayList<TaskAssignment>();

	public CommandAssignEquipmentToPartialTask(String boardId, LinkedHashMap<String, Object> map) {
		super(boardId, map);
	}
	...
	public void execute(Board board) throws OpsBoardError {
		...
		// Execute logic
		BoardEquipmentAndTasks bets = board.assignEquipmentToPartialTask(getTaskId(), getEquipmentId(),
				getSystemDateTime());
