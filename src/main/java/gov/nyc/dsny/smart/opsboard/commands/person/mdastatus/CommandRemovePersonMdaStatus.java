 ...
 */
@IMultiBoardCommandAnnotation(commandName = "RemovePersonMdaStatus")
public class CommandRemovePersonMdaStatus extends AbstractPersonMdaStatusCommand {

	private static final long serialVersionUID = 1L;

	public CommandRemovePersonMdaStatus() {
		super();
	}

	public CommandRemovePersonMdaStatus(LinkedHashMap<String, Object> map) {
		super(map);
	}

	public CommandRemovePersonMdaStatus(String boardId, String systemUser, Date systemDateTime, String boardPersonId,
	...
	public void execute(Board board) throws OpsBoardError {
		BoardPerson bp = board.getPersonOps().removePersonMdaStatus(getPersonId(), getMdaStatus());
	...
	protected void createAuditMessage(Board board, BoardPerson bp,
		...
		sb.append("Removed mda for person ");
